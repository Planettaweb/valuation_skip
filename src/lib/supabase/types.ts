...
//     WITH CHECK: ((org_id = get_user_org_id()) OR (get_user_role_name() = 'Admin'::text))
// Table: processamento_pdf
//   Policy "authenticated_delete_processamento_pdf" (DELETE, PERMISSIVE) roles={authenticated}
//     USING: true
//   Policy "authenticated_insert_processamento_pdf" (INSERT, PERMISSIVE) roles={authenticated}
//     WITH CHECK: true
//   Policy "authenticated_select_processamento_pdf" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: true
//   Policy "authenticated_update_processamento_pdf" (UPDATE, PERMISSIVE) roles={authenticated}
//     USING: true
//     WITH CHECK: true
// Table: role_permissions
