...
//   ativo_inativo: boolean (nullable, default: true)
...
//     WITH CHECK: ((org_id = get_user_org_id()) OR (get_user_role_name() = 'Admin'::text))
// Table: plano_contas_taxonomia
//   Policy "tenant_isolation_taxonomia_delete" (DELETE, PERMISSIVE) roles={authenticated}
//     USING: (org_id = get_user_org_id())
//   Policy "tenant_isolation_taxonomia_insert" (INSERT, PERMISSIVE) roles={authenticated}
//     WITH CHECK: (org_id = get_user_org_id())
//   Policy "tenant_isolation_taxonomia_select" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: (org_id = get_user_org_id())
//   Policy "tenant_isolation_taxonomia_update" (UPDATE, PERMISSIVE) roles={authenticated}
//     USING: (org_id = get_user_org_id())
//     WITH CHECK: (org_id = get_user_org_id())
// Table: role_permissions
